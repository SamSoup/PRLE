...
class SICKRSTSDataModule(BaseRegressionDataModule):
    """
    samsoup/sickr-sts DataModule
    ...
    Behaves exactly like STSBDataModule:
    ...
    def setup(self, stage: str = None):
        ...
        self.dataset = datasets.load_dataset("samsoup/sickr-sts")
